...
Create or update the appropriate spec or ticket file under `.scratch/<feature-slug>/` (creating the directory if needed).
...
- **Frontier**: numerically sort `.scratch/<effort>/tickets/` by ticket number, then pick the first file that is open, unblocked, and unclaimed.
