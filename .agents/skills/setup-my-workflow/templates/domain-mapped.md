...
This is a mapped-context repo. Use root `CONTEXT-MAP.md` to choose the relevant context file, and use root `docs/adr/` when ADRs exist.

## Before exploring, read these

- `CONTEXT-MAP.md` at the repo root.
- The relevant `CONTEXT.md` files named by the map.
