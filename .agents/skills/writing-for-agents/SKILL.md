...
description: Writing documents for agents. Use when creating or editing skills, modifying AGENTS.md or CLAUDE.md, or editing an agent-facing document reached through a context pointer.
---
